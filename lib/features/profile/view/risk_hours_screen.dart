...
class RiskHoursScreen extends StatefulWidget {
  const RiskHoursScreen({super.key});

  @override
  State<RiskHoursScreen> createState() => _RiskHoursScreenState();
}

class _RiskHoursScreenState extends State<RiskHoursScreen> {
  late List<String> _riskHours;

  @override
  void initState() {
    super.initState();
    _riskHours = List.from(context.read<SettingsBloc>().state.riskHours);
  }
  ...
  void _save() {
    context.read<SettingsBloc>().add(
      SettingsRiskHoursUpdated(List.of(_riskHours)),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Horários de Risco')),
      body: Padding(
