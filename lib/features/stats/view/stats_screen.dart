...
class StatsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final currentStreak = context.watch<StreakBloc>().state.days;
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          FilledButton.icon(
            onPressed: () => context.push(RelapseRouter.history),
          ...
          const SizedBox(height: 12),
          FilledButton.icon(
            onPressed: () => context.push(StatsRouter.weeklyReport),
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(label, style: text.bodyMedium?.copyWith(fontSize: 11)),
            ],
          ),
        ],
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text(
          'Próximo marco',
          style: text.bodyMedium?.copyWith(letterSpacing: 0.5, fontSize: 11),
        ),
        const SizedBox(height: 12),
        Row(
          children: [
            ...
            const SizedBox(width: 12),
            Expanded(child: Text(next.title, style: text.titleLarge)),
            Container(
